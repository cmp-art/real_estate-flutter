...
//
// Compares a live camera photo against a list of listing photos.
// Uses MobileNet V3 TFLite to extract feature vectors (softmax output),
// then computes cosine similarity between them.
//
// Scoring:  best cosine similarity × 60, clamped to [0, 60].
// Used only by VerificationService (near-owner path) before property is saved.
